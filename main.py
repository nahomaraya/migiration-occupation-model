# main.py
from dml_pipeline.stratified_dml import run_all_analyses, plot_forest
...
def main():
    ...
    # #
    # # # Generate plots
    # plot_forest(results['years_in_us'],
    #             "Q3: Immigrant Penalty by Years in US",
    #             f"{OUTPUT_DIR}/q3_forest.png")
    #
    # plot_forest(results['education'],
    #             "Q4: Immigrant Penalty by Education Level",
    #             f"{OUTPUT_DIR}/q4_forest.png")
    #
    # plot_forest(results['origin_development'],
    #             "Q5: Immigrant Penalty by origin Development Level",
    #             f"{OUTPUT_DIR}/q4_forest.png")
    ...
    print(f"Outcome Model R²: {results['outcome_r2']:.4f}")
    print(f"Treatment Model Accuracy: {results['treatment_accuracy']:.4f}")
